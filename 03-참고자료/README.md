...
React 학습 중 판단이 애매할 때 돌아오는 기준점입니다.

이 폴더는 링크를 많이 모으는 곳이 아니라, `01-학습문서`를 읽다가 더 정확한 근거가 필요할 때 확인하는 자료를 모읍니다. 먼저 공식 문서를 보고, 보조 자료는 그 다음에 봅니다.
...
- 공식 문서를 먼저 둡니다.
- 블로그 글은 공식 문서의 사고방식과 충돌하지 않을 때만 추가합니다.
- 오래된 class component 중심 자료는 제외합니다.
- 링크만 쌓지 말고, 왜 읽는지 한 줄 메모를 남깁니다.
